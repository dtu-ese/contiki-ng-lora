...
#else
#define TSCH_SX1272_TIMESLOT_TX_OFFSET 13000
#endif
...
#else
#define TSCH_SX1272_TIMESLOT_RX_ACK_DELAY 15000
#endif
...
#else
#define TSCH_SX1272_TIMESLOT_MAXACK 60000/*Assuming 17-byte acks*/
#endif

#ifdef TSCH_SX1272_TIMESLOT_CONF_MAXTX
#define TSCH_SX1272_TIMESLOT_MAXTX TSCH_SX1272_TIMESLOT_CONF_MAXTX
#else
#define TSCH_SX1272_TIMESLOT_MAXTX 240000
#endif
...
#else
#define TSCH_SX1272_TIMESLOT_TIMESLOTLENGTH 350000
#endif
