...
const RadioRegisters_t RadioRegsInitCopy[] = RADIO_INIT_REGISTERS_VALUE;/*This is lazy*/
static int on;
...
int init_sx1272(void){
    ...
    pins.Reset = BOARD_IOID_DIO15;
    pins.DIO[0] = BOARD_IOID_DIO26;
    pins.DIO[1] = BOARD_IOID_DIO27;
    pins.DIO[2] = BOARD_IOID_DIO28;
    pins.DIO[3] = BOARD_IOID_DIO29;
    //Dio 4 and 5 are unused in LoRa
    pins.DIO[4] = BOARD_IOID_DIO21;
    pins.DIO[5] = BOARD_IOID_DIO22;
    pins.ant_switch = BOARD_IOID_DIO30;
    pins.Spi.pin_spi_sck = EXT_FLASH_SPI_PIN_SCK;    
    pins.Spi.pin_spi_miso = EXT_FLASH_SPI_PIN_MISO;    
    pins.Spi.pin_spi_mosi = EXT_FLASH_SPI_PIN_MOSI;    
    pins.Spi.pin_spi_cs = EXT_FLASH_SPI_PIN_CS;
    pins.Spi.spi_bit_rate = 1000000;    
    pins.Spi.spi_pha = 0;    
    pins.Spi.spi_pol = 0;

    /*Tsch is not event-based*/
    SX1272Radio.Init( (RadioEvents_t *) &RadioEvents, &pins );
...
const struct radio_driver SX1272_tsch_driver = {
  init_sx1272,
  prepare_sx1272,
  transmit_sx1272,
  send_sx1272,
